...
# Simple PDF layout & generation library
module RcPdfLayout; end
...
require 'rcpdflayout/object/text_box'
require 'rcpdflayout/object/image'
require 'rcpdflayout/document'
